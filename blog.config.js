...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '弦图', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '咸鱼梦想家', // 作者简介
  ...
  GREETING_WORDS:
    ...
    'I'm XianTu, exploring the space between code and art with Unity and computer graphics,
This blog collects my technical experiments、visual sketches、and occasional thoughts on games、music and investing.',
